// V2.5-Evo - 2026-08-25 - Follow-Me starting-mode selector extended with F4 In Front (max 4). [SUPERSEDED 2026-08-27: F4 now uses the same radial engagement proof as F1-F3; front limits are warning-only.] UI only; no confStruct/SW_VERSION change.
...
{key:"followme_mode",label:"Follow-Me Starting Mode",description:"FM starting mode loaded on first arm this session. RAM override only — never written back to SPIFFS. 1=Near Right, 2=Behind (default), 3=Near Left, 4=In Front. Every F1-F4 mode engages from the same radial FM Engage Distance proof; F4 front-cone limits are warning-only.",group:"Follow-Me",type:"enum",def:2,min:1,max:4,options:[{v:1,l:"Near Right"},{v:2,l:"Behind (default)"},{v:3,l:"Near Left"},{v:4,l:"In Front"}]},
