...
{key:"fm_hold_duration_s",label:"FM Hold Time",description:"RIGHT-hold duration for the LEFT-tap → RIGHT-hold FM combo. Live and tunable: 3s (fast) to 10s (very deliberate). Default 3. This does not change armed mode selection: with trigger released, LEFT/RIGHT hold steps backward/forward through F1-F6 after 2s and every 2s while held; F0 is skipped.",group:"Follow-Me",type:"int",def:3,min:3,max:10,unit:"s"},
