...
<script>
// 62 user-facing RX parameters. This is every row of kCfgFields except the one
// intentionally-hidden reserved slot. Retired standalone-RTM fields are not descriptors. If you
