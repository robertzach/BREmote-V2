...
// V2.5-Evo - 2026-08-27 - Follow-Me selector extended to F4 Front Left, F5 Front and F6 Front Right. F4/F6 reuse near_diag_offset_deg on the common station radius. UI only; no confStruct/SW_VERSION change.
...
{key:"boogie_vmax_in_followme_kmh",label:"Boogie V-Max",description:"F1-F6 catch-up speed target outside the applicable radial or signed front-gap control band, and absolute ceiling for the in-band PI target. 0 opens only the catch-up speed cap to maximum rider-requested throttle; rider-relative PI regulation resumes in-band. A finite target reaches throttle cap 0 at target plus 2 km/h. Default 25 km/h. Set to a safe value for your terrain.",group:"Follow-Me",type:"float",def:25.0,min:0,max:100,step:0.1,unit:"km/h"},
