...
{key:"fm_engage_dist_m",label:"FM Engage / Return Distance",description:"The one radial activation boundary for every F1-F6 mode and the FM Return arrival radius. Valid values are 0=automatic or 8-50 m. Set at least one metre beyond the tow rope. Automatic computes 1.5 x (Min Distance + Smoothing Band), with the same 8 m floor. Automatic Follow-Me requires 2 continuous seconds outside this radius, including after a stationary Min Distance handoff entered FM Armed. A moving Min Distance recovery retains its proof. A stationary rider outside this radius can enter FM Return, which clears the separation latch. Arrival inside it enters FM_ARMED with the declaration preserved; a fresh proof outside this radius is required before automatic Follow-Me can engage again.",group:"Follow-Me",type:"float",def:0,min:0,max:50,step:0.5,unit:"m"},
