...
// V2.5-Evo - 2026-08-27 - Follow-Me help text documents radial-only D_engage activation, warning-only F4-F6 geometry and the min-distance cap-0 latch released by trigger release. Text only; no field/struct/SW_VERSION change. Kept byte-identical to the standalone tool.
