...
{key:"boogie_vmax_in_followme_kmh",label:"Boogie V-Max",description:"Absolute target clamp for the F1-F6 PI speed governor. 0 removes only this absolute clamp; the rider-relative governor remains active. The governor starts reducing throttle cap above its target and reaches cap 0 at target plus 2 km/h. Default 25 km/h. Set to a safe value for your terrain.",group:"Follow-Me",type:"float",def:25.0,min:0,max:100,step:0.1,unit:"km/h"},
